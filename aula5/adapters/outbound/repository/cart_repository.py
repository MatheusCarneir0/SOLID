...
from aula5.domain.ports.outbound.repository_protocol import (
    CartRepositoryProtocol
)
from aula5.domain.use_case.switch_cart_use_case import SwitchCartUseCase
from aula5.domain.entities.cart import Cart
