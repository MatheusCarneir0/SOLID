from aula2.domain.entities.carrinho import Carrinho
from aula2.domain.service.coupon.apply_coupon import ApplyCouponStrategy
from aula2.domain.factories.coupon_strategy_factory import (
