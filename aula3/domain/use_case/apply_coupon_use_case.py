from aula3.domain.entities.carrinho import Carrinho
from aula3.domain.service.coupon.apply_coupon import ApplyCouponStrategy
from aula3.domain.factories.coupon_strategy_factory import (
